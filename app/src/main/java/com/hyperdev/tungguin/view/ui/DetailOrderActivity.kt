...
import com.hyperdev.tungguin.view.DetailOrderView
...
class DetailOrderActivity : AppCompatActivity(), DetailOrderView.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        baseApiService = NetworkUtil.getClient(this@DetailOrderActivity)!!
            .create(BaseApiService::class.java)

        val request = DetailOrderRepositoryImpl(baseApiService)
        val scheduler = AppSchedulerProvider()
        presenter = DetailOrderPresenter(this@DetailOrderActivity, this@DetailOrderActivity, request, scheduler)
    ...
    override fun showDetailOrder(data: OrderDetailItem?) {
        ...
        when (getStatusDesign) {
            ...
            "in_progress" -> {
                ...
                name_designer.text = getDesignerName
            ...
            "pending" -> {
                ...
                name_designer.visibility = View.GONE
            ...
            "success" -> {
                ...
                btn_repeat_order.setOnClickListener {
                    ...
                    Toast.makeText(this@DetailOrderActivity, "Designer telah dipilih, silakan order kembali", Toast.LENGTH_LONG).show()
                    SharedPrefManager.getInstance(this@DetailOrderActivity).saveDesigner(getIdDesigner)
                    startActivity(Intent(this@DetailOrderActivity, Dashboard::class.java))
                    finish()
                }
            }
        }
            ...
            .setTransactionFinishedCallback {
                if (it.response != null) {
                    ...
                    if (it.status.equals(TransactionResult.STATUS_INVALID, ignoreCase = true)) {
                        ...
                        Toast.makeText(this@DetailOrderActivity, "Transaction Finished with failure.", Toast.LENGTH_LONG).show()
                    }
                }
            }

...
interface ChatRepository {
    ...
    fun getChatHistori(token: String, accept: String, hashed_id: String, page: Int?): Flowable<ChatHistoryResponse>

    // Digunakan untuk menampilkan daftar Chat Designer yang sedang aktif
    fun getChatList(token: String, accept: String, page: Int?): Flowable<ChatListResponse>

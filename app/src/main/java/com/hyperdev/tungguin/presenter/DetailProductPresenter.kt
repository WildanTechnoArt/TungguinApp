...
class DetailProductPresenter(private val view: DetailProductView.View,
                             private val context: Context,
                             private val detail: DetailProductRepositoryImpl,
                             private val scheduler: SchedulerProvider) : DetailProductView.Presenter{
    ...
    override fun getDetailProduct(token: String, hashed_id: String) {
        ...
        compositeDisposable.add(detail.getDetailProduct(token, "application/json", hashed_id)

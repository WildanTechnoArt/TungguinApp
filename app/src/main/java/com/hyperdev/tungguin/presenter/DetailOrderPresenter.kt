...
class DetailOrderPresenter(private val view: DetailOrderView.View,
                           private val context: Context,
                           private val detail: DetailOrderRepositoryImpl,
                           private val scheduler: SchedulerProvider) : DetailOrderView.Presenter{

    private val compositeDisposable = CompositeDisposable()

    override fun getUserProfile(token: String) {

        compositeDisposable.add(detail.getProfile(token, "application/json")

...
class OrderHistoriPresenter(private val view: HistoriOrderView.View,
                            private val context: Context,
                            private val history: OrderHIstoryRepositoryImpl,
                            private val scheduler: SchedulerProvider) : HistoriOrderView.Presenter{
    ...
    override fun getOrderHistory(token: String, page: Int) {
        ...
        compositeDisposable.add(history.getOrderHistory(token, "application/json", page)

...
class ChatHIstoriPresenter(private val view: ChatHistoriView.View,
                           private val context: Context,
                           private val chat: ChatHIstoriRepositoryImpl,
                           private val scheduler: SchedulerProvider) : ChatHistoriView.Presenter{
    ...
    override fun getDetailOrder(token: String, id: String) {
        view.showProgress()
        compositeDisposable.add(chat.getOrderDetail(token, "application/json", id)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(scheduler.io())
    ...
    override fun getChatData(token: String, hasher_id: String, page: Int) {
        view.showProgress()
        compositeDisposable.add(chat.getChatHistori(token, "application/json", hasher_id, page)
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(scheduler.io())
